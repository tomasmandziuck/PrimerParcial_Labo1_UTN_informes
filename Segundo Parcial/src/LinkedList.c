...
/** \brief Aplica descuentos a los elementos de la lista usando pFunc como criterio
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return LinkedList* Retorna  (NULL) Error: si el puntero a la listas es NULL
                                (puntero a la nueva lista) Si ok
...
/** \brief cuenta los elementos de la lista usando pFunc como criterio
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return int Retorna  el contador con la cantidad de veces que se dio el criterio
 */
